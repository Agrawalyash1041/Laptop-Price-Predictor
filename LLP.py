...
dataset = pickle.load(open('df.pkl','rb'))
...
Processor = st.selectbox('Name of the Processor (Please Select the Name of Processor)',dataset['CPU brand'].unique())

### GPU 

GPU = st.selectbox('GPU Brand (Please Select the Brand of GPU)',dataset['Gpu brand'].unique())
